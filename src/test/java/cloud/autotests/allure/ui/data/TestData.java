...
public class TestData {
    ...
    public static final String PROJECTS_URL = ConfigHelper.getBaseUrl();

    public static final String PROJECT_URL = ConfigHelper.getBaseUrl() + format("/project/%s", PROJECT_ID);
